...
- [x] **Modo Duelo de Dibujo 1vs1 Local con Juez Mágico AI:** Juego por turnos temporizado para 2 niños en el mismo dispositivo con prompts creativos generados por Gemini, evaluación visual multimodal en alta razonamiento (`gemini-3.5-flash`) y veredicto hablado.
